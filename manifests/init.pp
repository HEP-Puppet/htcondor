...
class htcondor (
  ...
  Boolan $leave_job_in_queue             = $htcondor::params::leave_job_in_queue,
  ...
  Boolan $use_accounting_groups          = $htcondor::params::use_accounting_groups,
  ...
  Boolan $use_htcondor_account_mapping   =
  ...
  Boolan $use_anonymous_auth             = $htcondor::params::use_anonymous_auth,
  Boolan $use_fs_auth                    = $htcondor::params::use_fs_auth,
  Boolan $use_password_auth              = $htcondor::params::use_password_auth,
  Boolan $use_kerberos_auth              = $htcondor::params::use_kerberos_auth,
  Boolan $use_claim_to_be_auth           = $htcondor::params::use_claim_to_be_auth,
  Boolan $use_cert_map_file              = $htcondor::params::use_cert_map_file,
  Boolan $use_krb_map_file               = $htcondor::params::use_krb_map_file,
  Boolan $use_ssl_auth                   = $htcondor::params::use_ssl_auth,
  Boolan $use_pid_namespaces             = $htcondor::params::use_pid_namespaces,
  Boolan $uses_connection_broker         = $htcondor::params::uses_connection_broker,
  ...
  Boolan $use_shared_port                = $htcondor::params::use_shared_port,
  ...
  Boolan $rotate_history_daily           = $htcondor::params::rotate_history_daily,
  Boolan $use_custom_logs                = $htcondor::params::use_custom_logs,
  Boolan $log_to_syslog                  = $htcondor::params::log_to_syslog,
  Hash $logging_parameters             = $htcondor::params::logging_parameters,
  Hash $custom_knobs                   = $htcondor::params::custom_knobs,
  Boolan $use_singularity                = $htcondor::params::use_singularity,
  String $singularity_path               = $htcondor::params::singularity_path,
  Boolan $force_singularity_jobs         = $htcondor::params::force_singularity_jobs,
